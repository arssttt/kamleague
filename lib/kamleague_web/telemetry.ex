defmodule KamleagueWeb.Telemetry do
  use Supervisor
  ...
  def metrics do
    [
      ...
      summary("kamleague.repo.query.total_time", unit: {:native, :millisecond}),
      summary("kamleague.repo.query.decode_time", unit: {:native, :millisecond}),
      summary("kamleague.repo.query.query_time", unit: {:native, :millisecond}),
      summary("kamleague.repo.query.queue_time", unit: {:native, :millisecond}),
      summary("kamleague.repo.query.idle_time", unit: {:native, :millisecond}),
